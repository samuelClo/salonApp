...
// .cls-2, fill"209b7.c"ls-3,.cls-4, fill=COLORS.cls4cls-5,.cls-6, fill=COLORS.cls6.cls-7,.fill={COLORS.cls7} cls-8{ fill=COLORS.cls8stroke:#000;stroke-miterlimit:10;stroke-width:0.25px;}.cls-2{ fillll:{COLORS.cls2}}.cls-3{ fill"#ffbf1ffill:#ffbf1f;}.cls-4{ fill=COLORS.cls4ill:#49b800;}.cls-5{fill:#11a3d0;}.cls-6{ fill=COLORS.cls6fill:#e07400;}.cls-7{ffill={COLORS.cls7} ill:#726565;}.cls-8{ fill=COLORS.cls8fill:aqua;}
    const COLORS= {
        cls1: '#f72585',
        cls2: "#209b7f",
        cls3: "#ffbf1f",
        ...
        <View style={{flex: 1, backgroundColor: 'red'}}>
            ...
            >
                ...
                >
                        ...
                        {/*<defs>*/}
                        {/*    <style>.cls-1{ fill=COLORS.cls1fill:#f72585;}.cls-1, fill=COLORS.cls1.cls-2, fill"209b7.c"ls-3,.cls-4, fill=COLORS.cls4cls-5,.cls-6, fill=COLORS.cls6.cls-7,.fill={COLORS.cls7} cls-8{ fill=COLORS.cls8stroke:#000;stroke-miterlimit:10;stroke-width:0.25px;}.cls-2{ fill"209b7fi"ll:{COLORS.cls2}}.cls-3{ fill"#ffbf1ffill:#ffbf1f;}.cls-4{ fill=COLORS.cls4ill:#49b800;}.cls-5{fill:#11a3d0;}.cls-6{ fill=COLORS.cls6fill:#e07400;}.cls-7{ffill={COLORS.cls7} ill:#726565;}.cls-8{ fill=COLORS.cls8fill:aqua;}.cls-9{font - size:6.89px;font-family:MyriadPro-Regular, Myriad Pro;}</style>*/}
                        {/*</defs>*/}
                      
                    
                    
                    <G scale="1">
                        <Rect stroke="#000" strokeMiterlimit={10} strokeWidth={0.25} className="cls-1" fill={COLORS.cls1} x="18.73" y="206.9" width="18.07" height="55.28" fill="#fdffb6"
                        ...
                        <Rect stroke="#000" strokeMiterlimit={10} strokeWidth={0.25} className="cls-7" fill={COLORS.cls7} x="131.04" y="452.74" width="40.35" height="6.64"
                              transform="translate(607.29 304.85) rotate(90)"/>
                        <Rect stroke="#000" strokeMiterlimit={10} strokeWidth={0.25} className="cls-7" fill={COLORS.cls7} x="144.52" y="153.82" width="23.64" height="6.64"

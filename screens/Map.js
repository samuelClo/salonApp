        ...
        <View style={{flex: 1, backgroundColor: 'red'}}>
            ...
            >
                <Svg
                    height={realHeight}
                    width={windowWidth}
                    viewBox={`-50 20 ${windowWidth / 2} 100`}
                    fill='blue'
                >
                    <G scale="0.4">


                        <Rect fill='blue' x="18.73" y="206.9" width="18.07" height="55.28"
                              transform="translate(262.3 206.78) rotate(90)"/>
                        <Rect className="cls-1" x="11.91" y="233.2" width="31.71" height="55.28"
                              transform="translate(288.6 233.07) rotate(90)"/>
                        <Rect className="cls-1" x="10.95" y="267.49" width="33.62" height="55.28"
                              transform="translate(322.89 267.36) rotate(90)"/>
                        <Rect className="cls-1" x="3.91" y="309.67" width="47.71" height="55.28"
                              transform="translate(365.07 309.55) rotate(90)"/>
                        <Rect className="cls-1" x="14.32" y="348.53" width="26.88" height="55.28"
                        ...
                        <Rect className="cls-1" x="76.07" y="172.3" width="10.35" height="39.4"
                              transform="translate(152.77 -3.83) rotate(43)"/>
                        <Rect className="cls-1" x="93.16" y="192.3" width="13.51" height="56.43"
                              transform="translate(320.44 120.6) rotate(90)"/>
                        <Rect className="cls-1" x="91.65" y="209.14" width="16.53" height="56.43"
                              transform="translate(337.28 137.45) rotate(90)"/>
                        <Rect className="cls-1" x="86.14" y="232.91" width="27.54" height="56.43"
                        ...
                        <Rect className="cls-1" x="86.19" y="278.89" width="15.18" height="44.16"
                              transform="translate(394.75 207.19) rotate(90)"/>
                        <Rect className="cls-1" x="86.37" y="295.65" width="14.82" height="44.16"
                        ...
                        <Rect className="cls-1" x="93.11" y="321.25" width="14" height="56.43"
                              transform="translate(449.57 249.36) rotate(90)"/>
                        <Rect className="cls-1" x="92.84" y="337.28" width="14.53" height="56.43"
                              transform="translate(465.6 265.39) rotate(90)"/>
                        <Rect className="cls-1" x="97.39" y="355.28" width="11.92" height="49.94"
                        ...
                        <Rect className="cls-1" x="113.18" y="436.88" width="24.77" height="24.12"
                              transform="translate(574.51 323.37) rotate(90)"/>
                        <Rect className="cls-1" x="124.2" y="485.42" width="32.28" height="15.25"
                        ...
                        <Rect className="cls-1" x="93.98" y="494.94" width="36.61" height="15.25"
                              transform="translate(395.8 72.68) rotate(46)"/>
                        <Polygon className="cls-1"
                                 points="113.95 526.76 92.93 506.6 92.65 496.44 118.09 522.77 113.95 526.76"/>
                        <Rect className="cls-1" x="146.94" y="397.43" width="21.75" height="19.71"
                              transform="translate(565.11 249.47) rotate(90)"/>
                        <Rect className="cls-1" x="146.94" y="373.04" width="21.75" height="19.71"
                              transform="translate(540.72 225.08) rotate(90)"/>
                        <Rect className="cls-1" x="146.94" y="348.37" width="21.75" height="19.71"
                              transform="translate(516.05 200.41) rotate(90)"/>
                        <Rect className="cls-1" x="146.88" y="239.32" width="21.75" height="19.71"
                              transform="translate(406.94 91.43) rotate(90)"/>
                        <Rect className="cls-1" x="146.88" y="214.94" width="21.75" height="19.71"
                              transform="translate(382.55 67.04) rotate(90)"/>
                        <Rect className="cls-1" x="146.88" y="190.27" width="21.75" height="19.71"
                        ...
                        <Rect className="cls-1" x="145.79" y="298.93" width="14.08" height="9.86"
                        ...
                        <Rect className="cls-1" x="131.04" y="452.74" width="40.35" height="6.64"
                              transform="translate(607.29 304.85) rotate(90)"/>
                        <Rect className="cls-1" x="144.52" y="153.82" width="23.64" height="6.64"
                              transform="translate(356.73 62.38) rotate(109.54)"/>
                        <Rect className="cls-1" x="173.44" y="86.46" width="21.75" height="19.71"
                              transform="translate(280.63 -88) rotate(90)"/>
                        <Rect className="cls-1" x="173.44" y="109.61" width="21.75" height="19.71"
                        ...
                        <Rect className="cls-1" x="117.66" y="160.06" width="16.71" height="16.71"
